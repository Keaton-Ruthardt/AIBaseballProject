...
class SimpleOutfielderTracker:
    ...
    def export_simple_csv(self, results: List[Dict], output_csv: str):
        ...
        - Frame number
        - Outfielder positions (x, y, tracking_id)
        - Who caught the ball
        """
        import pandas as pd
        ...
        for r in results:
            ...
            for player_id, player_data in r['tracked_players'].items():
                # Use player ID as suffix
            ...
            row['catch_distance_px'] = r['catcher_distance'] if r['catcher_distance'] else None
