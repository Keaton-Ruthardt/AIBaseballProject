...
AI Usage:
- Code organization and OpenCV understanding (GPT 5)
...
AI Usage:
- Understanding MLB Film Room and help with writing report over various other video sources (GPT 5)
...
AI Usage:
- Help with understanding the original model and various strategies to extract features from videos (GPT 5)
...
AI Usage: 
AI was used to (1) brainstorm and identify potential computer-vision tracking frameworks appropriate for the project (e.g., YOLOv8) (GPT 5)
