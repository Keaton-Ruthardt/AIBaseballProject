...
AI Usage:
I used AI to help refine the written explanation, including the objective, system flow description, and feature bullets, and to lightly polish the formatting of the code and CSV description. Mostly all core implementation logic, computer vision pipeline, tracking methods, and CSV export structure were written and tested by me. (Claude Sonnet)
...
AI Usage:
Samuel used AI (GPT 5) to help refine the wording and structure of this summary, including the descriptions of the model pipeline, engineered features, and technical achievements. All data integration logic, feature engineering steps, and validation processes were designed and implemented by Samuel using his own code and experiments.
