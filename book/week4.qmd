...
```
AI Usage:
I used AI (Claude Sonnet) to help refine the wording and organization of this write-up, including the descriptions of the system architecture, component integration, code implementation for clean reusable environment, and automation features. The overall pipeline design and model integration logic were created and tested by me.
...
AI Usage:
I used AI (Claude Sonnet) to help refine the wording and structure of this performance summary, including the explanation of timing instrumentation, result tables, and the analysis of CPU vs MPS performance. All benchmarking code, timing logic, hardware tests, and interpretations of the speedup results were designed and executed by me.
...
AI Usage:
Samuel used AI (GPT 5) to help refine the wording, structure, and clarity of this write-up, including the explanation of removed features, robustness logic, and performance trade-offs. All modeling decisions, code changes, feature selection, and evaluation metrics were based on his own experiments and implementation.
...
```
AI Assistance note - ChatGPT was used to aide in the creation of this script, specifically for generating and formatting print statements in a well formatted way.
...
AI Usage: 
I used AI (GPT 5) to help generate and format the print statements in the evaluation script and to polish the wording of the written summary. All evaluation logic, metric calculations, dataset setup, and analysis of results were implemented and interpreted by me.
...
AI Usage:
AI was used (GPT 5) to confirm the structure of a simple output function (a minimal, readable output/print or logging step) intended as a placeholder. Team leads implemented, integrated, and fully fleshed out the function in the main code.
